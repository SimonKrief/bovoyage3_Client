...
public class Destination  implements java.io.Serializable {
    ...
    /**
     * Gets the image value for this Destination.
     * 
     * @return image
     */
    ...
    /**
     * Sets the image value for this Destination.
     * 
     * @param image
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.bovoyages.gtm.fr/", "destination"));
