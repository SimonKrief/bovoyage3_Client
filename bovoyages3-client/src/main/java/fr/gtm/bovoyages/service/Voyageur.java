...
public class Voyageur  implements java.io.Serializable {
    ...
    private fr.gtm.bovoyages.service.LocalDate dateNaissance;
    ...
    public Voyageur(
           ...
           fr.gtm.bovoyages.service.LocalDate dateNaissance,
           long id,
     ...
     */
    public fr.gtm.bovoyages.service.LocalDate getDateNaissance() {
        return dateNaissance;
    }
     ...
     * @param dateNaissance
     */
    public void setDateNaissance(fr.gtm.bovoyages.service.LocalDate dateNaissance) {
        this.dateNaissance = dateNaissance;
    }
